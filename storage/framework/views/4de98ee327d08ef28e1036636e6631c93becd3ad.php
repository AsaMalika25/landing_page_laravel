    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              <li><a class="getstarted scrollto" href="<?php echo e(url('login')); ?>">Lihat detail</a></li>
            </ul>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 footer-links">
              <h4>Lihat Detail</h4>
              <ul>
                <li><i class="bx bx-chevron-right"></i> <a href="<?php echo e(url('login')); ?>">Lihat detail</a></li>
              </ul>
            </div>
